...
namespace Test.Ioc
{
    public class TransientTest
    {
        ...
        public void Single()
        {
            ...
            ISingleService s3 = services.Get<ISingleService>(scope);
            Assert.NotEqual(s1.Foo, s3.Foo);
            s3.Foo = "b";

            //two transient instances in same scope should not be equal
            ISingleService s4 = services.Get<ISingleService>(scope);
        ...
        public void Nested()
        {
            ...
            IFirstChildService firstScoped = services.Get<IFirstChildService>(scope);
            ISecondChildService secondScoped = services.Get<ISecondChildService>(scope);
